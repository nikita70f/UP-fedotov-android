    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        post = Post(
            ...
            content = "✨ Новая коллекция шуб уже в нашем магазине! ✨\n" +
                    "Мы рады представить вам свежие поступления:\n" +
                    "роскошные норковые шубы в классических и современных силуэтах;\n" +
                    "лёгкие и тёплые модели из каракуля;\n" +
                    "стильные укороченные варианты из мутона.\n" +
                    "Каждая шуба — это сочетание:\n" +
                    "безупречного кроя;\n" +
                    "премиального меха;\n" +
                    "актуального дизайна.\n" +
